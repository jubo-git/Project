...
**#1  - Tier: DTP at 12 months (Justification on this one)
	...
	**Model 1.1: Continuous Dose
	xtreg dtp_12m c.total_tier##i.post, fe vce(cluster onscode) //i.year not included toallow for average policy effect. The dynamic effects were verified in the event study 
