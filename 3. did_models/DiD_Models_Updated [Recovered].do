...
**Quick Access 
	...
	xtreg dtp_12m i.tier_quintile##i.post, fe vce(cluster onscode)
...
**#1  - Tier: DTP at 12 months (Justification on this one)
	...
	**Model 1.1: Continuous Dose
	xtreg dtp_12m c.total_tier##i.post, fe vce(cluster onscode) //i.year not included toa llow for average policy effect. The dynamic effects were verified in the event study 
	
	xtreg dtp_12m c.total_tier##i.post c.total_tier#c.total_tier#i.post, fe vce(cluster ons_id)
	...
	**Model 1.4: With NOMIS Controls
	regress dtp_12m c.total_tier##i.post black_pct other_pct hh_deprived_1_pct hh_deprived_3_pct hh_deprived_4_pct christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct sikh_pct otherreligion_pct, vce(cluster onscode)
	estat vif
...
**#2  - Tier: DTP at 24 months
	...
	**Model 2.4: With NOMIS Controls
	regress dtp_24m c.total_tier##i.post black_pct other_pct hh_deprived_1_pct hh_deprived_3_pct hh_deprived_4_pct christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct sikh_pct otherreligion_pct, vce(cluster onscode)
	estat vif
...
**#3  - Tier: MMR1 at 24 months
	...
	**Model 3.4: With NOMIS Controls
	regress mmr1_24m c.total_tier##i.post black_pct other_pct hh_deprived_1_pct hh_deprived_3_pct hh_deprived_4_pct christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct sikh_pct otherreligion_pct, vce(cluster onscode)
	estat vif
...
**#4  - Tier: DTP at 5 years
	...
	**Model 4.4: With NOMIS Controls
	regress dtp_5y c.total_tier##i.post black_pct other_pct hh_deprived_1_pct hh_deprived_3_pct hh_deprived_4_pct christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct sikh_pct otherreligion_pct, vce(cluster onscode)
	estat vif
...
**#5  - Tier: DTP Booster at 5 years
	...
	**Model 5.4: With NOMIS Controls
	regress dtp_boost_5y c.total_tier##i.post black_pct other_pct hh_deprived_1_pct hh_deprived_3_pct hh_deprived_4_pct christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct sikh_pct otherreligion_pct, vce(cluster onscode)
	estat vif
...
**#6  - Tier: MMR1 at 5 years
	...
	**Model 6.4: With NOMIS Controls
	regress mmr1_5y c.total_tier##i.post black_pct other_pct hh_deprived_1_pct hh_deprived_3_pct hh_deprived_4_pct christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct sikh_pct otherreligion_pct, vce(cluster onscode)
	estat vif
...
**#7 : MMR2 at 5 years
	...
	**Model 7.4: With NOMIS Controls
	regress mmr2_5y c.total_tier##i.post black_pct other_pct hh_deprived_1_pct hh_deprived_3_pct hh_deprived_4_pct christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct sikh_pct otherreligion_pct, vce(cluster onscode)
	estat vif
