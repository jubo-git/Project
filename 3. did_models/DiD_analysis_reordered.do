...
regress dtp_12m c.total_tier#i.post ///
...
regress dtp_24m c.total_tier#i.post ///
    asian_pct black_pct mixed_pct other_pct ///
    hh_deprived_1_pct  hh_deprived_2_pct hh_deprived_3_pct hh_deprived_4_pct ///
    christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct ///
    sikh_pct otherreligion_pct i.year, ///
...
regress mmr1_24m c.total_tier#i.post ///
    asian_pct black_pct mixed_pct other_pct ///
    hh_deprived_1_pct  hh_deprived_2_pct hh_deprived_3_pct hh_deprived_4_pct ///
    christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct ///
    sikh_pct otherreligion_pct i.year, ///
...
regress dtp_5y c.total_tier#i.post ///
    asian_pct black_pct mixed_pct other_pct ///
    hh_deprived_1_pct  hh_deprived_2_pct hh_deprived_3_pct hh_deprived_4_pct ///
    christian_pct buddhist_pct hindu_pct jewish_pct muslim_pct ///
    sikh_pct otherreligion_pct i.year, ///
...
**# SENSITIVITY / ROBUSTNESS CHECK — Multi-Tier Model
...
**# Multi-tier model but with potentially right function lol 
	xtreg dtp_12m ib1.tier_quartile#1.post i.year, fe vce(cluster onscode)
	xtreg dtp_24m ib1.tier_quartile#1.post i.year, fe vce(cluster onscode)
	xtreg mmr1_24m ib1.tier_quartile#1.post i.year, fe vce(cluster onscode)
	xtreg dtp_5y ib1.tier_quartile#1.post i.year, fe vce(cluster onscode)
	xtreg dtp_boost_5y ib1.tier_quartile#1.post i.year, fe vce(cluster onscode)
