...
preserve 
    collapse (mean) total_tier tier_quartile, by(onscode) 
...
preserve 
    ...
    * Cumulative Tier Score (Composite Index) 
...
**# 1.4.2 Vaccination Uptake across LAs (MMR and Hexavalent) 
 
codebook hex_1y hex_2y mmr1_2y hib_men_boost_2y ///
...
foreach var in hex_1y hex_2y mmr1_2y hib_men_boost_2y ///
               hex_5y dtp_boost_5y mmr1_5y mmr2_5y hib_men_boost_5y { 
...
graph combine gr_hex_1y gr_hex_2y gr_mmr1_2y gr_hib_men_boost_2y ///
              gr_hex_5y gr_dtp_boost_5y gr_mmr1_5y gr_mmr2_5y ///
              gr_hib_men_boost_5y, ///
...
* 1. Summary of Demographic Shares across Tier Quartiles 
