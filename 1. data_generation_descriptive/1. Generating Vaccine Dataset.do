...
copy "`repo'/2024-to-2025-cover-anual-data-tables.xlsx" "temp_2024_25.xlsx", replace
	...
	*T4a_UTLA12m [A8: G167] (6in1_1y)
	...
	rename coverageat12monthsdtapipvh hex_1y
	keep onscode laname region hex_1y
	drop if missing(onscode) | onscode == "ONS Code"
	tempfile data1y
	save "`data1y'"
	
	*T5a_UTLA24m [A8: I167] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2024_25.xlsx", sheet("T5a_UTLA24m") cellrange(A8:I167) firstrow clear
	drop OrganisationDataServicecode Note Numberaged24months
	rename *, lower
	rename localauthority laname
	rename code onscode
	rename regionname region 
	rename coverageat24monthsdtapipvh hex_2y
	rename coverageat24monthsmmr1 mmr1_2y
	rename coverageat24monthshibmencb hib_men_boost_2y
	keep onscode laname region hex_2y mmr1_2y hib_men_boost_2y
	drop if missing(onscode) | onscode == "ONS Code"
	tempfile data2y
	save "`data2y'"
	
	*T6a_UTLA5y [A8: K167] (6in1_5y & DTaP/IPV-containing booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2024_25.xlsx", sheet("T6a_UTLA5y") cellrange(A8:K167) firstrow clear
	drop OrganisationDataServicecode Note Numberaged5years 
	rename *, lower
	rename localauthority laname
	rename code onscode
	rename regionname region 
	rename coverageat5yearsdtapipvhib hex_5y
	rename coverageat5yearsdtapipvb* dtp_boost_5y
	rename coverageat5yearsmmr1 mmr1_5y
	rename coverageat5yearsmmr2 mmr2_5y
	rename coverageat5yearshibmencboo hib_men_boost_5y
	keep onscode laname region hex_5y dtp_boost_5y mmr1_5y mmr2_5y hib_men_boost_5y
	drop if missing(onscode) | onscode == "ONS Code"
	tempfile data5y
	save "`data5y'"
	...
	*Merge all temp files to create 2025 dataset 
	use "`data1y'", clear
	merge 1:1 onscode using "`data2y'", nogenerate
...
copy "`repo'/2023%20-%202024%20childhood-vaccinations.xlsx" "temp_2023_24.xlsx", replace
	...
	*Table 9a [A21: H169] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2023_24.xlsx", sheet("Table 9a") cellrange(A21:H169) clear
	drop D E 
	rename A onscode
	rename B laname
	rename C region
	...
	drop if missing(onscode) | onscode == "ONS Code"
	tempfile data2y_24
	save "`data2y_24'", replace
	
	*Table 10a [A21: J169] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2023_24.xlsx", sheet("Table 10a") cellrange(A21:J169) clear
	drop D E
	rename A onscode
	rename B laname
	rename C region
	...
	*Merge all temp files to create 2024 dataset 
	use "`data1y_24'", clear
	merge 1:1 onscode using "`data2y_24'", nogenerate
...
copy "`repo'/2022-2023-childhood_vaccination_datatables.xlsx" "temp_2022_23.xlsx", replace
	...
	*Table 9a [A21: H169] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2022_23.xlsx", sheet("Table 9a") cellrange(A21:H169) clear
	drop D E 
	rename A onscode
	rename B laname
	rename C region 
	...
	*Table 10a [A21: J169] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2022_23.xlsx", sheet("Table 10a") cellrange(A21:J169) clear
	drop D E
	rename A onscode
	rename B laname
	rename C region
	...
	*Merge all temp files to create 2023 dataset 
	use "`data1y_23'", clear
	merge 1:1 onscode using "`data2y_23'", nogenerate
...
copy "`repo'/2021-22%20Childhood%20Vaccination%20Statistics.xlsx" "temp_2021_22.xlsx", replace
	...
	*Table 9b [B31: H203] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2021_22.xlsx", sheet("Table 9b") cellrange(B31:H203) clear
	drop D E
	rename B laname
	rename C onscode
	rename F hex_2y
	...
	*Table 10b [B31: J203] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2021_22.xlsx", sheet("Table 10b") cellrange(B31:J203) clear
	drop D E
	rename B laname
	rename C onscode
	rename F hex_5y
	...
	*Merge all temp files to create 2022 dataset 
	use "`data1y_22'", clear
	merge 1:1 onscode using "`data2y_22'", nogenerate
...
copy "`repo'/2020-21-Childhood%20Vaccination%20Statistics.xlsx" "temp_2020_21.xlsx", replace
	...
	*Table 9b [B31: H202] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2020_21.xlsx", sheet("Table 9b") cellrange(B31:H202) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_2y
	rename G mmr1_2y
	rename H hib_men_boost_2y
	destring hib_men_boost_2y, replace ignore(":")
	keep onscode laname hex_2y mmr1_2y hib_men_boost_2y
	drop if missing(onscode) | onscode == "ONS Code"
	tempfile data2y_21
	save "`data2y_21'"

	*Table 10b [B31: J202] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2020_21.xlsx", sheet("Table 10b") cellrange(B31:J202) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_5y
	...
	*Merge all temp files to create 2021 dataset 
	use "`data1y_21'", clear
	merge 1:1 onscode using "`data2y_21'", nogenerate
...
copy "`repo'/2019-20-child-vacc-stat-eng-data-tables.xlsx" "temp_2019_20.xlsx", replace
	...
	*Table 9b [B30: H201] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2019_20.xlsx", sheet("Table 9b") cellrange(B30:H201) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_2y
	...
	*Table 10b [B31: J202] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2019_20.xlsx", sheet("Table 10b") cellrange(B31:J202) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_5y
	...
	*Merge all temp files to create 2020 dataset 
	use "`data1y_20'", clear
	merge 1:1 onscode using "`data2y_20'", nogenerate
...
copy "`repo'/2018-19-child-vacc-stat-eng-tables.xlsx" "temp_2018_19.xlsx", replace
	...
	*Table 9b [B30: H202] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2018_19.xlsx", sheet("Table 9b") cellrange(B30:H202) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_2y
	...
	*Table 10b [B31: J203] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2018_19.xlsx", sheet("Table 10b") cellrange(B31:J203) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_5y
	...
	*Merge all temp files to create 2019 dataset 
	use "`data1y_19'", clear
	merge 1:1 onscode using "`data2y_19'", nogenerate
...
copy "`repo'/2017-18-child-vacc-stat-eng-tab.xlsx" "temp_2017_18.xlsx", replace
	...
	*Table 9b [B30: H202] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2017_18.xlsx", sheet("Table 9b") cellrange(B30:H202) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_2y
	...
	*Table 10b [B31: J203] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2017_18.xlsx", sheet("Table 10b") cellrange(B31:J203) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_5y
...
copy "`repo'/2016-17-nhs-immu-stat-eng-tab.xlsx" "temp_2016_17.xlsx", replace
	...
	*Table 9b [B30: H202] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2016_17.xlsx", sheet("Table 9b") cellrange(B30:H202) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_2y
	...
	*Table 10b [B31: J203] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2016_17.xlsx", sheet("Table 10b") cellrange(B31:J203) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_5y
	...
	*Merge all temp files to create 2017 dataset 
	use "`data1y_17'", clear
	merge 1:1 onscode using "`data2y_17'", nogenerate
...
copy "`repo'/2015-16-nhs-immu-stat-eng-tab.xlsx" "temp_2015_16.xlsx", replace
	...
	*Table 11a [B30: H202] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2015_16.xlsx", sheet("Table 11a") cellrange(B30:H202) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_2y
	...
	*Table 12a [B31: J203] (6in1_5y & booster & mmr1_5y & mmr2_5y & Hib/MenC booster) 
	import excel "temp_2015_16.xlsx", sheet("Table 12a") cellrange(B31:J203) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_5y
	...
	*Merge all temp files to create 2016 dataset 
	use "`data1y_16'", clear
	merge 1:1 onscode using "`data2y_16'", nogenerate
...
copy "`repo'/2014-15-nhs-immu-stat-eng-tab.xlsx" "temp_2014_15.xlsx", replace
	...
	*Table 11a [B23: H195] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2014_15.xlsx", sheet("Table 11a") cellrange(A23:H195) clear
	drop D E 
	rename C onscode
	rename A region
	rename B laname
	...
	*Table 12a [B24: J196] (6in1 & DTaP/IPV-containing booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	...
	*Merge all temp files to create 2015 dataset 
	use "`data1y_15'", clear
	merge 1:1 onscode using "`data2y_15'", nogenerate
...
copy "`repo'/2013-14-nhs-immu-stat-eng-tab-exc.xlsx" "temp_2013_14.xlsx", replace
	...
	*Table 11a [B22: H194] (6in1_2y & mmr1_2y & Hib/MenC booster)
	import excel "temp_2013_14.xlsx", sheet("Table 11a") cellrange(A22:H194) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_2y
	...
	*Table 12a [B23: J195] (6in1 & DTaP/IPV-containing booster & mmr1_5y & mmr2_5y & Hib/MenC booster)
	import excel "temp_2013_14.xlsx", sheet("Table 12a") cellrange(A23:J195) clear
	drop D E
	rename C onscode
	rename B laname
	rename F hex_5y
...
*Create a Northamptonshire Variable (using the average of the post 2021 regions to create a Northamptonshire 2014 - 2025 variable)
	...
	* Calculate averages for the split authorities
	local vars hex_1y hex_2y mmr1_2y hib_men_boost_2y hex_5y dtp_boost_5y mmr1_5y mmr2_5y hib_men_boost_5y
...
collapse (sum) hex_1y hex_2y mmr1_2y hib_men_boost_2y hex_5y dtp_boost_5y mmr1_5y mmr2_5y hib_men_boost_5y, by(onscode laname region year)
