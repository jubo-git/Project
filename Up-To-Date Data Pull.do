...
**#Quartile Binning (All Scores)
	...
	**Total Weighted Lockdown Score
		xtile totalquintile = weightedtotalscore, nquantiles(5)

	**Convenience: School Closures
		xtile primaryquintile  = weighted_primary,   nquantiles(5)
		xtile secondaryquintile= weighted_secondary, nquantiles(5)

	**Confidence: Tier Severity
