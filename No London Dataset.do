...
**Confidence: Tier A Severity (local infection-rate-based tiers)
xtile tieraquintile = tierdays_a, nquantiles(5)

**Confidence: Tier B Severity (Plan A/B measures)
xtile tierbquintile = tierdays_b, nquantiles(5)
//Tier A and Tier B kept separate rather than combined: they represent distinct policy regimes from different phases of the pandemic
...
save "data_clean/Lockdown Dataset NO LONDON", replace
...
save "data_clean/MMR Dataset NO LONDON.dta", replace
...
clear
use "data_clean/MMR Dataset NO LONDON.dta"
merge m:1 onscode using "data_clean/Lockdown Dataset NO LONDON.dta", nogenerate
drop laname code 

* Save intermediate file to clean data subfolder
save "data_clean/Lockdown_MMR_Data_NL.dta", replace


**#5 Combining NOMIS, Lockdown and Vaccine
clear
use "data_clean/Lockdown_MMR_Data_NL.dta"
...
save "data_clean/Lockdown_MMR_NOMIS_NO_LONDON.dta", replace
